ditech.POS.CustomerOrderList = class {
  ...
  prepare_dom() {
    this.wrapper.append(
      `<section class="customer-order-list">
				<div class="filter-section">
					<div class="label">${__("Customer Orders")}</div>
    ...
    this.$component = this.wrapper.find(".customer-order-list");
  ...
  bind_events() {
    ...
    this.$invoices_container.on("click", ".invoice-wrapper", function () {
      ...
      me.events.open_customer_invoice_data(invoice_name);
    });
  }
  ...
  refresh_list() {
    ...
    return frappe.call({
      method: "ditech_core.ditech_core.pos.get_customer_order_list",
      freeze: true,
  ...
  get_invoice_html(invoice) {
    ...
    return `<div class="invoice-wrapper" data-invoice-name="${escape(
      invoice.name
            ...
            format_currency(invoice.total, invoice.currency) || 0
          }</div>
